...
# 盾の反射
## 右
execute at @e[tag=sh,sort=nearest,limit=1] unless block ^1.1 ^ ^1 air unless block ^1.1 ^ ^1 grass at @p run playsound minecraft:item.shield.break player @p ~ ~ ~ 0.5
execute at @e[tag=sh,sort=nearest,limit=1] unless block ^1.1 ^ ^1 air unless block ^1.1 ^ ^1 grass run tp @e[tag=sh,sort=nearest,limit=1] ~ ~ ~ ~90 ~
## 左
execute at @e[tag=sh,sort=nearest,limit=1] unless block ^-1.1 ^ ^1 air unless block ^-1.1 ^ ^1 grass at @p run playsound minecraft:item.shield.break player @p ~ ~ ~ 0.5
execute at @e[tag=sh,sort=nearest,limit=1] unless block ^-1.1 ^ ^1 air unless block ^-1.1 ^ ^1 grass run tp @e[tag=sh,sort=nearest,limit=1] ~ ~ ~ ~-90 ~
## 上
...
## 下
execute at @e[tag=sh,sort=nearest,limit=1] unless block ^ ^0.8 ^1 air unless block ^0.8 ^ ^1 grass run tp @e[tag=sh,sort=nearest,limit=1] ~ ~ ~ ~ ~90
