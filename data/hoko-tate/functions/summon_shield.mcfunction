...
execute store result score @e[tag=sh,sort=nearest,limit=1] ht-rotation-x run data get entity @a[distance=..10,sort=nearest,limit=1] Rotation[0]
execute store result score @e[tag=sh,sort=nearest,limit=1] ht-rotation-y run data get entity @a[distance=..10,sort=nearest,limit=1] Rotation[1]
